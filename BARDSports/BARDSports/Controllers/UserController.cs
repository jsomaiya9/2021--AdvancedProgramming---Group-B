...
namespace BARDSports.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,Email,Password,Role")] UserModel userModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,Email,Password,Role")] UserModel userModel)
        {
            if (ModelState.IsValid)
            {
